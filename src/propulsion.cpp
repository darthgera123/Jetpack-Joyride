...
Prop::Prop(float x, float y, float bottom) {
    this->position = glm::vec3(x, y, 0);
    float r =0.025;
    this->radius = r;
    this->speed.v_x = 0.03;
    this->speed.v_y = 0.025;
    this->speed.g = 0.001;
    this->speed.d_y =0;
    ...
    this->object_base = create3DObject(GL_TRIANGLES, 3*n, circle_vertex_buffer_data, COLOR_GREY, GL_FILL);
}
